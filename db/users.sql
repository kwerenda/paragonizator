...
$body$
;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO mobileapp;
GRANT SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA public to mobileapp;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES  TO mobileapp;
